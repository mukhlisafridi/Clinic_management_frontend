  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-blue-50 h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="max-w-6xl w-full mx-4 bg-white rounded-xl shadow-2xl overflow-hidden flex max-h-[95vh]">
        ...
        {/* Left Side - Hospital Image/Branding */}
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              ...
              <div className="space-y-2 text-left">
                <div className="flex items-center gap-2 text-white">
                  ...
                  <span className="text-xs">24/7 Medical Support</span>
                </div>
                <div className="flex items-center gap-2 text-white">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                ...
                <div className="flex items-center gap-2 text-white">
                  ...
                  <span className="text-xs">Easy Appointments</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full lg:w-3/5 p-4 md:p-5 overflow-y-auto">
          {/* Header */}
          <div className="mb-3">
            <h2 className="text-lg md:text-xl font-bold text-blue-900 mb-0.5">
          ...
          <form onSubmit={handleSubmit} className="space-y-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              ...
              {/* First Name */}
              <div>
                <label htmlFor="firstName" className="block text-xs font-semibold text-blue-900 mb-0.5">
                  First Name *
                </label>
                <input
                  type="text"
                  ...
                  autoComplete="off"
                  disabled={isLoading}
                  className="w-full px-2.5 py-1.5 text-sm border border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition text-blue-900 bg-white disabled:bg-gray-100"
              ...
              {/* Last Name */}
              <div>
                <label htmlFor="lastName" className="block text-xs font-semibold text-blue-900 mb-0.5">
                  Last Name *
                </label>
                <input
                  type="text"
              ...
              {/* Email */}
              <div>
                <label htmlFor="email" className="block text-xs font-semibold text-blue-900 mb-0.5">
                  Email Address *
                </label>
                <input
                  type="email"
              ...
              {/* Phone */}
              <div>
                <label htmlFor="phone" className="block text-xs font-semibold text-blue-900 mb-0.5">
                  Phone Number *
                </label>
                <input
                  type="tel"
              ...
              {/* NIC */}
              <div>
                <label htmlFor="nic" className="block text-xs font-semibold text-blue-900 mb-0.5">
                  NIC Number *
                </label>
                <input
                  type="text"
              ...
              {/* Date of Birth */}
              <div>
                <label htmlFor="dob" className="block text-xs font-semibold text-blue-900 mb-0.5">
                  Date of Birth *
                </label>
                <input
                  type="date"
              ...
              {/* Gender */}
              <div>
                <label htmlFor="gender" className="block text-xs font-semibold text-blue-900 mb-0.5">
                  Gender *
                </label>
                <select
                  id="gender"
                  ...
                  autoComplete="off"
                  disabled={isLoading}
                  className="w-full px-2.5 py-1.5 text-sm border border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition bg-white text-blue-900 appearance-none cursor-pointer disabled:bg-gray-100"
              ...
              {/* Password */}
              <div>
                <label htmlFor="password" className="block text-xs font-semibold text-blue-900 mb-0.5">
                  Password *
                </label>
                <div className="relative">
                  <input
                    ...
                    disabled={isLoading}
                    className="w-full px-2.5 py-1.5 pr-8 text-sm border border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition text-blue-900 bg-white disabled:bg-gray-100"
