...
const PatientCareSection = () => {
  ...
  return (
    <div id="patientCareSection" className="px-4 sm:px-6 md:px-12 lg:px-24 min-h-screen flex flex-col justify-center items-center bg-white">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
        ...
        <div className={`transition-all duration-1000 ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-10"}`}>
          ...
          <p className="text-base sm:text-lg mb-4 md:mb-6 text-gray-600 leading-relaxed">
        ...
        <div className={`transition-all duration-1000 ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-10"}`}>
          <div className="relative">
            ...
            />
            {/* Decorative Element */}
            <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-blue-200 rounded-full opacity-30 blur-2xl -z-10"></div>
            <div className="absolute -top-4 -left-4 w-32 h-32 bg-blue-400 rounded-full opacity-20 blur-2xl -z-10"></div>
          </div>
        </div>
